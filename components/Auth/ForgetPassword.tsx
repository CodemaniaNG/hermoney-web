...
const ForgetPassword = () => {
  ...
  return (
    <Box>
      <HeadTitle title="Forgot Password" />
      <Grid>
        ...
        <Wrapper>
          <Flex direction="column" align="center">
            ...
            <Text fw={400} fz={rem(14)} ta="center" c={appColors.darkGray} mb={rem(32)} mt={rem(8)}>
              Kindly check your email to access the link to reset your password
            </Text>
            <Button style={{ borderRadius: 1000 }} onClick={() => setModalClose(false)}>
              Go back
            </Button>
          </Flex>
        </Wrapper>
